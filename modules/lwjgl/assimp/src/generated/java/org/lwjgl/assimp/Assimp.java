...
public class Assimp {
     ...
     * 
     * <p>Some importers are providing a mechanism to define a scaling unit for the model. This post processing step can be used to do so.</p>
     * 
     * <p>Use {@link #AI_CONFIG_GLOBAL_SCALE_FACTOR_KEY} to control this.</p>
     * </li>
     ...
     * @param value  New value for the property
     */
    public static void aiSetImportPropertyInteger(@NativeType("struct aiPropertyStore *") AIPropertyStore store, @NativeType("const char *") CharSequence szName, int value) {
        MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
        try {
     ...
     * @param value  New value for the property
     */
    public static void aiSetImportPropertyFloat(@NativeType("struct aiPropertyStore *") AIPropertyStore store, @NativeType("const char *") CharSequence szName, float value) {
        MemoryStack stack = stackGet(); int stackPointer = stack.getPointer();
        try {
            ByteBuffer szNameEncoded = stack.ASCII(szName);
    ...
    /** register Array version of: {@link #aiGetMaterialFloatArray GetMaterialFloatArray} */
    @NativeType("aiReturn")
    ...
    /** register Array version of: {@link #aiGetMaterialIntegerArray GetMaterialIntegerArray} */
    @NativeType("aiReturn")
    ...
    /** register Array version of: {@link #aiGetMaterialTexture GetMaterialTexture} */
    @NativeType("aiReturn")
